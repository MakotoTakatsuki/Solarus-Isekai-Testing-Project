return function(game)
  ...
  function game:initialize_hud()
    ...
    local clock_builder = require("hud/clock")
    ...
    menu:set_dst_position(120, 7)
    self.hud[#self.hud + 1] = menu

    menu = small_keys_builder:new(self)
    menu:set_dst_position(160, 8)
    self.hud[#self.hud + 1] = menu
    ...
    menu:set_dst_position(53, 35)
    self.hud[#self.hud + 1] = menu
    self.hud.action_icon = menu
  
    menu = clock_builder:new(self)
    menu:set_dst_position(280, 180)
    self.hud[#self.hud + 1] = menu
  ...
  function game:check_hud()
    ...
    if map ~= nil then
      ...
      if not self.hud.showing_dialog and
        ...
        self.hud.action_icon:set_dst_position(53, 35)
